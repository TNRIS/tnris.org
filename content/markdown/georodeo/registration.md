...
<!-- <h3>Sorry, registration is not yet open. Please check back in.</h3>
<h3 style="color: #7D54C4;">Don't forget to mark your calendar for May 16 & 17, 2019!</h3>
<br> -->

<!-- <p class="lead">Lunch will be provided to registered attendees. You must complete and successfully submit this form in advance of the event to receive lunch.</p>

<div>{% include "events/georodeo-2019/georodeo-registration.njk" %}</div> -->

<h3>Registration is now closed. But don't worry, if you'd still like to attend come on by...</h3>
<br>
<img src='https://cdn.tnris.org/images/walkens.jpg' style='width:100%' alt='walkens welcome'>
