...
angular.module('ConfigApp', [])
  .constant('CONTACT_SUBMIT_URL', 'https://localhost:8000/api/v1/contact/submit/')
  .constant('ZIP_UPLOAD_POLICY_URL', 'https://localhost:8000/api/v1/contact/policy/zip-upload')
  .constant('FILE_UPLOAD_POLICY_URL', 'https://localhost:8000/api/v1/contact/policy/file-upload')
  .constant('IMAGE_UPLOAD_POLICY_URL', 'https://localhost:8000/api/v1/contact/policy/image-upload')
